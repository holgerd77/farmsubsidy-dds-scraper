...
+=============================+=========================================+=====================+=======================================================================+
| farmsubsidy-dds             | Scraping infrastructure                 | ``Pre-Alpha``       | `GitHub <https://github.com/holgerd77/farmsubsidy-dds>`__             |
+-----------------------------+-----------------------------------------+---------------------+-----------------------------------------------------------------------+
| farmsubsidy-dds-elastic     | Search Index                            | ``Planning``        | Documentation                                                         |
+-----------------------------+-----------------------------------------+---------------------+-----------------------------------------------------------------------+ 
| farmsubsidy-dds-backend-api | Backend/API                             | ``Not Started``     | `GitHub <https://github.com/holgerd77/farmsubsidy-dds-backend-api>`__ |
+-----------------------------+-----------------------------------------+---------------------+-----------------------------------------------------------------------+
| farmsubsidy-dds-frontend    | Frontend                                | ``Not Started``     | `GitHub <https://github.com/holgerd77/farmsubsidy-dds-frontend>`__    |
+-----------------------------+-----------------------------------------+---------------------+-----------------------------------------------------------------------+
