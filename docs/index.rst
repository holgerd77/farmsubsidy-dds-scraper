...
+=====================================================================+=========================================+=====================+====================+
| `scraper <https://github.com/openfarmsubsidies/scraper>`__          | Scraping                                | ``Beta``            | 2017-06-28         |
+---------------------------------------------------------------------+-----------------------------------------+---------------------+--------------------+
| `elastic <https://github.com/openfarmsubsidies/elastic>`__          | Search Index                            | ``Beta``            | 2017-06-28         |
+---------------------------------------------------------------------+-----------------------------------------+---------------------+--------------------+ 
| `backend-api <https://github.com/openfarmsubsidies/backend-api>`__  | Backend/API                             | ``Beta``            | 2017-06-28         |
+---------------------------------------------------------------------+-----------------------------------------+---------------------+--------------------+
| `frontend <https://github.com/openfarmsubsidies/frontend>`__        | Frontend                                | ``Beta``            | 2017-06-28         |
+---------------------------------------------------------------------+-----------------------------------------+---------------------+--------------------+
